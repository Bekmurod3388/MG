        ...
        <li class="nav-item">
            ...
            <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="#">Harakat sensor 1</a>
                    <a class="collapse-item" href="#">Harakat sensor2</a>
                    <a class="collapse-item" href="#">Eshik 1</a>
                    <a class="collapse-item" href="#">Eshik 2</a>
                </div>
            </div>
        </li>
